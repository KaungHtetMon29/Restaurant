...
export function Home() {
  ...
  return (
    <div className="flex relative 2xl:mx-82 2xl:mb-40 xl:mx-32 xl:mb-20 lg:mx-32 lg:mb-20">
      <div className="2xl:text-6xl w-1/2 2xl:pt-60 xl:pt-60 xl:text-5xl lg:pt-52 lg:text-4xl flex flex-col xl:gap-2 lg:gap-8">
        <motion.p
        ...
        <motion.p
          className="font-segoe font-normal 2xl:text-xl 2xl:mt-24 xl:text-lg lg:text-lg xl:mt-8 w-3/4 2xl:leading-10 xl:leading-8 lg:leading-8 ..."
          initial={{ opacity: 0 }}
        ...
        <motion.div
          className="flex 2xl:w-1/3 2xl:mt-20 xl:mt-5 xl:w-1/2 lg:w-1/2 lg:mt-3 gap-4"
          initial={{ opacity: 0 }}
      ...
      >
        <div className="2xl:w-11/12 justify-end 2xl:mt-40 xl:m-auto xl:mt-36 xl:w-fit  xl:mr-0 lg:m-auto lg:mt-32 lg:w-96 flex">
